...
if os.path.exists('/var/www/trade-exec-engine/resources/test'):
    TEST_RESOURCE_DIR = '/var/www/trade-exec-engine/resources/test'
else:
    TEST_RESOURCE_DIR = "/Users/pralhad/Documents/99-src/98-trading/trade-exec-engine/resources/test"
MKT_PRICE_TYPE = 'MKT'
...
class TestApis(unittest.TestCase):
    ...
    @patch('exec.service.engine.api.single_order_history')
...
class TestLoadParams(unittest.TestCase):
    ...
    @patch.dict('exec.service.engine.cfg', {"generated": TEST_RESOURCE_DIR})
    @patch('exec.service.engine.api_get_order_book')
...
class TestOperation(unittest.TestCase):
    ...
    @patch('exec.service.engine.api.single_order_history')
    @patch('exec.service.engine.api_place_order')
    ...
    @patch('exec.service.engine.api_modify_order')
    ...
    @patch('exec.service.engine.api_cancel_order')
    ...
    @patch('exec.service.engine.api_unsubscribe', Mock(side_effect=None))
    @patch('exec.service.engine.api_modify_order')
    @patch('exec.service.engine.api_cancel_order')
